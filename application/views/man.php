...
<title>买男装,时尚男装网,男装品牌,男装搭配,劲霸男装</title>
<meta name="description" content="男装服饰网上购物麦路客分为上装有T恤,背心,长袖,衬衫,棉毛衫,针织衫,毛衣,马甲,大衣,羽绒服,下装有牛仔裤,休闲裤,短裤,运动裤,裤子,袜子有短袜,长袜." />
<meta name="keywords" content="网上购物,男装,男装品牌,时尚男装,休闲男装,运动男装,商务男装,男装搭配,劲霸男装,T恤,背心,长袖,衬衫,棉毛衫,针织衫,毛衣,马甲,大衣,羽绒服,牛仔裤,休闲裤,短裤,运动裤,裤子,袜子,短袜,长袜" />
...
<body>
<h1 class="descriptionhide">网上购物,男装,男装品牌,时尚男装,休闲男装,运动男装,商务男装,男装搭配,劲霸男装,T恤,背心,长袖,衬衫,棉毛衫,针织衫,毛衣,马甲,大衣,羽绒服,牛仔裤,休闲裤,短裤,运动裤,裤子,袜子,短袜,长袜</h1>
<div class="side_con">
	<div class="l_m">
		<div class="f_l l_m_l">
			您好，欢迎来麦路客商城！
...
<div class="content container">
	<div class="breadcrumbs"><a href="index.php/user/index">首页</a><span>></span>男装</div><!--breadcrumbs end-->
	<div class="area_l con_l">
		<div class="product-sort">
			<h2>商品分类</h2>
			<div class="sort-con">
				<div class="sort-list">
					<h3><span class="f_l icon02"></span><a href="#" class="f_l">男装</a></h3>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="index.php/user/man?id1=8" class="f_l">上装</a></dt>
						<dd>
							<a class="current" href="index.php/user/man?id=22"><span>·</span>T恤 </a>
							<a href="index.php/user/man?id=23"><span>·</span>风衣 </a>
							
						</dd>
					</dl>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="index.php/user/man?id1=9" class="f_l">下装</a></dt>
						<dd>
							<a href="index.php/user/man?id=24"><span>·</span>哈伦裤 </a>
							<a href="index.php/user/man?id=25"><span>·</span>小脚裤 </a>
							<a href="index.php/user/man?id=26"><span>·</span>短裤 </a>
							
						</dd>
					</dl>
				</div>
				<!-- <div class="sort-list"><h3><span class="f_l icon03"></span><a href="airplane.html" class="f_l">飞机模型</a></h3></div> -->
				<div class="sort-list"><h3><span class="f_l icon02"></span><a href="#" class="f_l">女装</a></h3></div>
				<div class="sort-list"><h3><span class="f_l icon04"></span><a href="#" class="f_l">鞋子</a></h3></div>
				<div class="sort-list"><h3><span class="f_l icon05"></span><a href="#" class="f_l">箱包</a></h3></div>
			</div><!--sort-con end-->
