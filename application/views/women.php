...
<div class="content container">
	<div class="breadcrumbs"><a href="index.php/user/index">首页</a><span>></span>女装</div><!--breadcrumbs end-->
	<div class="area_l con_l">
		<div class="product-sort">
			<h2>商品分类</h2>
			<div class="sort-con">
				<div class="sort-list">
					<h3><span class="f_l icon01"></span><a href="" class="f_l">女装</a></h3>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="index.php/user/women?id1=5" class="f_l">上装</a></dt>
						<dd>
							<a class="current" href="index.php/user/women?id=15"><span>·</span>T恤 </a>
							<a href="index.php/user/women?id=17"><span>·</span>打底衫</a>
							<a href="index.php/user/women?id=16"><span>·</span>雪纺衫 </a>
						</dd>
					</dl>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="index.php/user/women?id1=6" class="f_l">下装</a></dt>
						<dd>
							<a href="index.php/user/women?id=18"><span>·</span>亚麻裤 </a>
							<a href="index.php/user/women?id=19"><span>·</span>小脚裤裤 </a>
						</dd>
					</dl>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="index.php/user/women?id1=7" class="f_l">裙子</a></dt>
						<dd>
							<a href="index.php/user/women?id=20"><span>·</span>连衣裙 </a>
							<a href="index.php/user/women?id=21"><span>·</span>蓬蓬裙 </a>
						</dd>
					</dl>
				</div>
				<!-- <div class="sort-list"><h3><span class="f_l icon03"></span><a href="airplane.html" class="f_l">飞机模型</a></h3></div> -->
				<div class="sort-list"><h3><span class="f_l icon02"></span><a href="#" class="f_l">男装</a></h3></div>
