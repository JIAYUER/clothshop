...
<div class="side_con">
	<div class="l_m">
		<!-- <div class="f_l l_m_l">
			您好，欢迎来到服装商城！<a href="index.php/user/login" class="huise">[登录]</a><a href="index.php/user/register" class="huise">[免费注册]</a>
		</div> --><!--l_m_l end-->
		<div class="f_r l_m_r">
			<ul class="clearfix">
				...
				<!-- <li class="my-mesaer"><a href="index.php/user/myMesaer">我的麦路客<span class="arrow"></span></a>
					<ul id="my-list">
						<li><a href="index.php/user/myOrder">我的订单</a></li>
						<li><a href="index.php/user/myFaq">我的问答</a></li> 
						<li><a href="index.php/user/myFavorites">我的收藏</a></li> 
						<li><a href="index.php/user/myPoints">我的积分</a></li> 
					</ul>
				</li> 
		-->
			</ul>
...
<div class="header container">
	...
	<div class="site-nav">
		<div class="floor_nav">
			...
			<div class="buy_cart">
				<a class="gocart" href="index.php/user/cart">购物车<b class="yellow">312310</b>件</a>
					...
					<div class="sort clearfix">
						<ul class="f_l sort_nav">
							<li>
								<dl>
									<dt><a href="#">上装 ></a></dt>
									<dd><span><a href="#">T恤</a></span><span><a href="#">打底衫</a></span><span><a href="#">雪纺衫</a></span></dd>
								</dl>
							</li>
							<li>
								<dl>
									<dt><a href="#">下装 ></a></dt>
									<dd><span><a href="#">亚麻裤</a></span><span><a href="#">小脚裤</a></span></dd>
								</dl>
							</li>
							<li>
								<dl>
									<dt><a href="#">裙子 ></a></dt>
									<dd><span><a href="#">连衣裙</a></span><span><a href="#">蓬蓬裙</a></span></dd>
								</dl>
							</li>
						</ul><!--sort_nav end-->
					</div><!--sort end-->
					...
					<div class="sort clearfix">
						<ul class="f_l sort_nav">
							<li>
								<dl>
									<dt><a href="#">上装 ></a></dt>
									<dd><span><a href="#">T恤</a></span><span><a href="#">风衣</a></span></dd>
								</dl>
							</li>
							<li>
								<dl>
									<dt><a href="#">下装 ></a></dt>
									<dd><span><a href="#">哈伦裤</a></span><span><a href="#">小脚裤</a></span><span><a href="#">短裤</a></span></dd>
								</dl>
							</li>
						</ul><!--sort_nav end-->
					</div><!--sort end-->
				...
				<div class="meun_sort">
					<div class="sort clearfix" >
						<ul class="f_l sort_nav">
							<li>
								<dl>
									<dt><a href="index.php/user/shoes">男鞋 ></a></dt>
									<dd><span><a href="index.php/user/shoes">运动鞋</a></span></dd>
								</dl>
							</li>
							 <li>
								<dl>
									<dt><a href="index.php/user/shoes">女鞋 ></a></dt>
									<dd><span><a href="index.php/user/shoes">凉鞋</a></span><span><a href="index.php/user/shoes">高跟鞋</a></span>
									</dl>
							</li>
						</ul><!--sort_nav end-->
					</div><!--sort end-->
					...
					<div class="sort clearfix">
						<ul class="f_l sort_nav">
							<li>
								<dl>
									<dt><a href="#">箱包></a></dt>
									<dd><span><a href="#">拉杆箱</a></span><span><a href="#">布箱</a></span></dd>
								</dl>
							</li>
					</div><!--sort end-->
				</div><!--meun_sort end-->	
...
<div class="content container">
	...
	<div class="dl_zc">
		...
		<div class="dl-con" id="regist">
			<form id="formpersonal"  action="<?php echo site_url("user/do_reg")?>" method="post" >
			<div class="form">
				<!-- <div class="tipinfo">注册成为会员并完善个人信息，可获得 <span class="red">10点</span>积分</div> -->
				<div class="item">
					<span class="label">用户名：</span>
					<div class="fl">
						<input type="text" id="username" name="uname" class="text" tabindex="1" />
				...
				<div class="item">
					...
					<div class="fl">
						<input type="text" id="mail" name="mailbox" class="text" tabindex="4"/>
				...
				<div class="item">
					...
					<input type="submit" class="yellow_button yellow_button_03" id="registsubmit"  value="提交注册信息" tabindex="8" />
				</div><!--item end-->
			</div>
			</form>
		</div><!--regist end-->
